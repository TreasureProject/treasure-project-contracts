...
const tree = require('../data/december_migration/tree.json');
const cards = require('../data/cards_collections.json');

task('deploy-cards-claim-3').setAction(async function () {
  ...
  deployments.cardsMerkleProofClaim3 = cardsMerkleProofClaim.address;
